...
def generate_via_rest_client(text: str = None,
                             ...
                             token: str = None):
    try:
        inference_url = inference_url or os.getenv('inference_url', inference_url) \
...
def call_openai(prompt: str, instruction: str = None):
    ...
    instruction = instruction or "You are an AI assistant that helps people find information"
