...
async def start_chat() -> None:
    ...
    server_params = StdioServerParams(
        ...
        "/home/hosseina/Desktop",
        "/home/hosseina/Pictures"
        ]
    )
    ...
    assistant = AssistantAgent(
        ...
        1. Execute file system operations using available tools (list_dir, read_file, file_search, grep_search)
        ...
        5. Call 'APPROVE' only after showing the complete results
    ...
    inner_team = RoundRobinGroupChat([mcp_agent, assistant], termination_condition=inner_termination)
